...
(function ($, window, document) {
    ...
    $.fn.stickyNavbar = function (prop) {
        ...
        var options = $.extend({
            ...
            activeSign: true, //active sign,
            verticalSelfTop: 0, //vertical top
        ...
        return this.each(function () {
            ...
            var $self = $(this),
                ...
                menuItems = options.selector === "a" ? $self.find('a') : $self.find(options.selector), // Navigation lists or links
                menuItemsHref = $self.find('li a[href*=#]'); // href attributes of navigation links
                
                if(options.type == 'vertical'){
                    thisHeight = 0;
                    $selfScrollTop = options.verticalSelfPos;
                }

            $self.data('options', $.extend({}, options));
