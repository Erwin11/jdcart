        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="tab-general" style="margin:0 1em;">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="enname" id="enname" value="{{ Input::old('enname', $data->enname) }}" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  ') }}
                    <select class="form-control" name="parent_id" id="parent">
                        ...
                        @include('widgets.adminSubcates', array('items' => $catesData, 'dataid' => $data->parent_id))
                    </select>
                </div>
                <div class="form-group">
